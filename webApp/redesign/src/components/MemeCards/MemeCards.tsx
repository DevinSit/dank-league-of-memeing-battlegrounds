...
const MemeCards = ({className}: MemeCardsProps) => {
    ...
    const bind = useDrag(
        ({args: [index], down, movement: [_, my], direction: [__, yDir], velocity}) => {
            ...
            const dir = yDir < 0 ? -1 : 1; // Direction should either point up or down
            ...
            api.start((i) => {
                ...
                const y = isGone ? (200 + window.innerWidth) * dir : down ? my : 0; // When a card is gone it flies out up or down, otherwise goes back to zero
